<template>
	<div class="section">
        ...
        <ul class="goods">
            <router-link :to="'/pafou/'+item.id" tag='li' v-for='item in fn'>
...
export default{
    data(){
        return{
            fn:'',
            data1:[
                {'img':'./static/images/spin1.jpg'
                    // 'span':刷刷地址
                },
                {'img':'./static/images/spin2.jpg'
                    // 'span':刷刷地址
                },
                {'img':'./static/images/spin3.jpg'
                    // 'span':刷刷地址
                }
            ]
        }
    ...
    methods:{
        arr(){
            this.$http.get('static/json/spincen.json')
                .then(
                    function(res){
                        this.fn = res.body
                    },function(ree){
